...
19. 我还能使用 Pironman5 Max 的震动开关功能吗？

----------------------------------------------------------------------------------------------------------------------------

Pironman5 Max 的震动开关功能在 1.3.6 版本之后不再兼容软件。这是版本迭代带来的变更，并非硬件故障。如果您依赖此功能，可以考虑回滚到之前的版本、手动修改代码或向官方支持提交请求。OLED 屏幕的显示时间仍然可以通过命令行进行调整。按下按钮一次即可激活 OLED 屏幕，屏幕会持续亮起几秒钟。