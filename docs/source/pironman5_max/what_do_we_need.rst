...
Before assembling and using your Pironman 5 MAX, please make sure you have the following components ready. Some items are required for basic operation, while others are optional and depend on how you plan to use your Raspberry Pi.
