...
If you have installed the Home Assistant system, you will need to add the necessary add-ons to Home Assistant and start them to get the Pironman 5 Pro MAX working.
...
* After starting Pironman 5 Pro MAX, it is recommended to plug in an Ethernet cable directly. This way, you can open your computer browser and enter: ``homeassistant.local:8123`` to access Home Assistant.
...
The functionality of Pironman 5 Pro MAX is installed on Home Assistant in the form of add-ons. First, you need to add the **SunFounder** add-ons repository.
...
The **Pi Config Wizard** can help enable the configurations needed for Pironman 5 Pro MAX, such as I2C and SPI. If not needed afterward, it can be removed.
...
4. Install the **Pironman 5 Pro MAX** Add-on
---------------------------------------------

Now officially start installing the **Pironman 5 Pro MAX** add-on.
...
#. Find **Pironman 5 Pro MAX** in the **SunFounder** add-ons list and click to enter.

   .. image:: img/home_pironman5_max_addon.png
      :width: 90%

#. Now install the Pironman 5 Pro MAX add-on.
...
#. Now you can click **OPEN WEB UI** to open the Pironman 5 Pro MAX web page. You can also check the option to display the Web UI in the sidebar. This will allow you to see the Pironman 5 Pro MAX option in the left sidebar of Home Assistant, and click to open the Pironman 5 Pro MAX page.
