...
Now that the system has been written to either the Micro SD or NVMe SSD, you can insert them into the Pironman 5 Pro MAX slot. Then press the power button to turn on the device.
