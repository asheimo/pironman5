...
.. warning::
   ...
   The procedure here is consistent with :ref:`install_os_sd_rpi_promax`, but when selecting an image, please choose Raspberry Pi OS Lite from Raspberry Pi OS (other).
