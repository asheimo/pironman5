...
| Fan LED state | `sudo pironman5 -fl on\|off\|follow` |
| Fan LED pin | `sudo pironman5 -fp 5` |
...
# 2. Install pironman5 module
curl -sSL "https://raw.githubusercontent.com/sunfounder/sunfounder-installer-scripts/main/pironman5/install.sh" | sudo bash
# → Select "3) Pironman 5 Max"
...
| Fan LED | GPIO5 | Jumper-controlled |
| OLED | I2C SDA/SCL | Address 0x3C |
| CPU Fan | 4-pin PWM header | Firmware-controlled |

Remove jumpers to free pins for alternate use. Solder bridge option for always-on fan/LED.
